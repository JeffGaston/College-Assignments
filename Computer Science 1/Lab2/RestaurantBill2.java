/*
   ...
   Date: 2/7/2019
   Title: RestaurantBill2.java
   Description: Calculates the tax on an item whether the user qualifies for dicount.
...
public class RestaurantBill2{
   public static void main(String[] args){
      ...
      if(price >= 100){
         System.out.println("You qualify for $20 off your next meal.");
      }
      else{
         System.out.println("No coupons offered this time.");
      }
      
      if(tipPercentage >= .20)
         System.out.println("Very generous tip, thank you!");
   }//ends main
}//ends the tax class